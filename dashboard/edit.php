...
if(is_post_request()) {
  ...
  $args['bericht_modifiedby'] = $session->username;

  $post->merge_attributes($args);
  $result = $post->save();

  if($result === true) {
    $_SESSION['message'] = 'Bericht succesvol bijgewerkt';
    redirect_to(url_for('/dashboard/details.php?id=' . $id));
  } else {
    // show errors
  }
      ...
      <div class="col-md-9 ">
        <div class="container bg-light py-2">
          ...
          <form class="needs-validation" novalidate
            action="<?php echo url_for('/dashboard/edit.php?id=' . h(u($id))); ?>" method="post">
